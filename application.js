System.register([], function (_export, _context) {
  ...
  function createApplication(_ref) {
    ...
    function start(_ref3) {
      ...
      document.getElementById("splashEarthSpin").style.display = 'block';
      var settings;
      var cc;
      var ccLoad = Promise.resolve().then(function () {
        return topLevelImport('cc');
      }).then(function (engine) {
        return cc = engine;
      });
      var settingsLoad = Promise.resolve().then(function () {
        return loadSettingsJson();
      });
      return Promise.all([ccLoad, settingsLoad]).then(function () {
  ...
  function onGameStarted(cc, settings) {
    ...
    cc.director.loadScene(launchScene, null, function () {
      ...
      document.getElementById("splashEarthSpin").style.display = 'none';
