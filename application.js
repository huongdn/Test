System.register([], function (_export, _context) {
  ...
  function createApplication(_ref) {
    ...
    let date = new Date();
    console.log('createApplication: min: ' + date.getMinutes() + ', seconds: ' + date.getSeconds());
  ...
  function onGameStarted(cc, settings) {
    let date = new Date();
    console.log('onGameStarted: min: ' + date.getMinutes() + ', seconds: ' + date.getSeconds());
    ...
    date = new Date();
    console.log('onGameStarted(Start load scene): min: ' + date.getMinutes() + ', seconds: ' + date.getSeconds());
    cc.director.loadScene(launchScene, null, function () {
      cc.view.setDesignResolutionSize(1080, 1920, 2);
	  document.getElementById("splash").style.display = 'none';
      console.log("Success to load scene: ".concat(launchScene));
      date = new Date();
      console.log('onGameStarted(Success to load scene): min: ' + date.getMinutes() + ', seconds: ' + date.getSeconds());
    });
  }
